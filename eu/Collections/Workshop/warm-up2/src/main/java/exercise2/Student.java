...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if(!this.id.equals(st.id))return false;
        if(!this.firstName.equals(st.firstName))return false;
        if(!this.lastName.equals(st.lastName))return false;
        if(!this.averageGrade.equals(st.averageGrade))return false;
    ...
    public int hashCode() {
        ...
        result= 31*result +this.averageGrade.hashCode();
        return result;
