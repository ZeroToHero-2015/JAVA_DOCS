...
public class Student {
    ...
    public String toString() {
       ...
       return " First Name = "+ firstName + " Last Name = "+lastName+ " id = "+id+ " AverageGrade = "+ averageGrade;
    }
    ...
    public boolean equals(Object o) {
        ...
        if(this.id != st.id || !this.firstName.equals(st.firstName) || !this.lastName.equals(st.lastName) || !this.averageGrade.equals(st.averageGrade)){
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 29*result+ averageGrade.hashCode();
